...
#============callback函数里面不允许写变量..........  #参考https://www.cnpython.com/qa/68533
    ...
    #     if i==2:
    #         b=tkinter.Button(frame, text =labellist[2], command = lambda :helloCallBack(colorlist[2]))
    #         b.grid(row=0,column=(2+1),padx=10)
    # #================下面一排是全标注===全文有这个词的直接全标注上.
    #
    #         b=tkinter.Button(frame, text =labellist[2]+'全标注', command = lambda :helloCallBack_quanbiaozhu(colorlist[2]))
    #         b.grid(row=1,column=(2+1),padx=10)
    #     if i==3:
    #         b=tkinter.Button(frame, text =labellist[3], command = lambda :helloCallBack(colorlist[3]))
    #         b.grid(row=0,column=(3+1),padx=10)
    # #================下面一排是全标注===全文有这个词的直接全标注上.
    #
    #         b=tkinter.Button(frame, text =labellist[3]+'全标注', command = lambda :helloCallBack_quanbiaozhu(colorlist[3]))
    #         b.grid(row=1,column=(3+1),padx=10)
    #     if i==4:
    #         b=tkinter.Button(frame, text =labellist[4], command = lambda :helloCallBack(colorlist[4]))
    #         b.grid(row=0,column=(4+1),padx=10)
    # #================下面一排是全标注===全文有这个词的直接全标注上.
    #
    #         b=tkinter.Button(frame, text =labellist[4]+'全标注', command = lambda :helloCallBack_quanbiaozhu(colorlist[4]))
    #         b.grid(row=1,column=(4+1),padx=10)
    #     if i==5:
    #         b=tkinter.Button(frame, text =labellist[5], command = lambda :helloCallBack(colorlist[5]))
    #         b.grid(row=0,column=(5+1),padx=10)
    # #================下面一排是全标注===全文有这个词的直接全标注上.
    #
    #         b=tkinter.Button(frame, text =labellist[5]+'全标注', command = lambda :helloCallBack_quanbiaozhu(colorlist[5]))
    #         b.grid(row=1,column=(5+1),padx=10)
    #     if i == 6:
    #             b = tkinter.Button(frame, text=labellist[6], command=lambda: helloCallBack(colorlist[6]))
    #             b.grid(row=0, column=(6 + 1), padx=10)
    #             # ================下面一排是全标注===全文有这个词的直接全标注上.
    #
    #             b = tkinter.Button(frame, text=labellist[6] + '全标注',
    #                                command=lambda: helloCallBack_quanbiaozhu(colorlist[6]))
    #             b.grid(row=1, column=(6 + 1), padx=10)
    #     if i == 7:
    #         b = tkinter.Button(frame, text=labellist[7], command=lambda: helloCallBack(colorlist[7]))
    #         b.grid(row=0, column=(7 + 1), padx=10)
    #         # ================下面一排是全标注===全文有这个词的直接全标注上.
    #
    #         b = tkinter.Button(frame, text=labellist[7] + '全标注',
    #                            command=lambda: helloCallBack_quanbiaozhu(colorlist[7]))
    #         b.grid(row=1, column=(7 + 1), padx=10)
    #     if i == 8:
    #             b = tkinter.Button(frame, text=labellist[8], command=lambda: helloCallBack(colorlist[8]))
    #             b.grid(row=0, column=(8 + 1), padx=10)
    #             # ================下面一排是全标注===全文有这个词的直接全标注上.
    #
    #             b = tkinter.Button(frame, text=labellist[8] + '全标注',
    #                                command=lambda: helloCallBack_quanbiaozhu(colorlist[8]))
    #             b.grid(row=1, column=(8 + 1), padx=10)
    #
    #     if i == 9:
    #         b = tkinter.Button(frame, text=labellist[9], command=lambda: helloCallBack(colorlist[9]))
    #         b.grid(row=0, column=(9 + 1), padx=10)
    #         # ================下面一排是全标注===全文有这个词的直接全标注上.
    #
    #         b = tkinter.Button(frame, text=labellist[9] + '全标注',
    #                            command=lambda: helloCallBack_quanbiaozhu(colorlist[9]))
    #         b.grid(row=1, column=(9 + 1), padx=10)
